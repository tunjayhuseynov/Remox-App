...
const CoinItem = ({ title, coin, usd, percent, rate, img }: { title: string, coin: string, usd: string, percent: string, rate: string, img: string }) => {
    ...
    return <div className="py-2 pl-1 gap-2 pr-5 flex bg-greylish bg-opacity-5 rounded-xl h-[60px]">
        ...
        <div className="flex-grow grid grid-cols-3 gap">
            ...
            <div className="flex flex-col justify-between items-end">
                <div className="font-semibold text-gray-500 text-sm">{rate}%</div>
